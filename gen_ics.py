...
technical = [
  ...
  ('2026-06-22','1v1s to Goal','4:30 PM','6:00 PM','Harry Downes Field',
   ['Beating a defender 1v1 to goal','Placing a finish into the far corner under pressure','Closing down a shooter to force a rushed attempt','Using a block tackle or interception to prevent a shot on goal']),
  ('2026-06-23','Your Choice!','6:00 PM','7:30 PM','Harry Downes Field',
   ["Open to suggestions on what you'd like to do today! If you'd like to suggest a theme or specific activity, please add it to the comment in your RSVP."]),
  ('2026-06-25','First Touch & Receiving','6:00 PM','7:30 PM','Harry Downes Field',
  ...
  ('2026-06-29','Finishing vs. Defensive Pressure','6:00 PM','7:30 PM','Harry Downes Field',
...
fitness = [
  ...
  (1, '2026-06-21','Harvard Stadium Climb! + Ball Control','8:30 AM','10:00 AM','Harvard Stadium',
   "We will walk, jump, and run up the Harvard Stadium steps! Then, we'll juggle. Please bring sneakers, cleats, and a ball."),
  (1, '2026-06-24','Strength + Conditioning','4:00 PM','6:00 PM','Harry Downes Field',
